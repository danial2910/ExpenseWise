...
export type Feature = 'TRANSACTIONS' | 'CATEGORIES' | 'BUDGETS' | 'REPORTS' | 'AI_ASSISTANT'

export const ALL_FEATURES: Feature[] = ['TRANSACTIONS', 'CATEGORIES', 'BUDGETS', 'REPORTS', 'AI_ASSISTANT']
